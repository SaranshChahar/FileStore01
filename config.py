...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("7590082923:AAHnXN-N8iTPJe3oo5jlJ1AikB_J3CEnGDg", "8154426339")
APP_ID = int(os.environ.get("22902589", "")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("3045f3e99c422584a2b587e0d9731170", "") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002170811388")) #Your db channel Id
OWNER = os.environ.get("HKB_Owner", "sewxiy") # Owner username without @
OWNER_ID = int(os.environ.get("7385295244", "7328629001")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("-1002374777646", "")
